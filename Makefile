...
profile: CFLAGS=-c -O3 -std=c++11 -ansi-alias
profile: PROFFLAG=-prof-gen
profile: OPTFLAG=

debug: CFLAGS=-c -O0 -std=c++11 -g -Wall -pedantic -DVERBOSE
debug: LD=g++
debug: OPTFLAG=
debug: PROFFLAG=
...
test: CFLAGS=-c -O0 -std=c++11 -g -Wall -pedantic
test: LD=g++
test: OPTFLAG=
test: PROFFLAG=

det: CFLAGS=-c -O3 -std=c++11 -ansi-alias -fno-exceptions -D DETERMINISTIC

mpi: CC=mpicxx
mpi: CFLAGS=-c -O3 -std=c++11 -ansi-alias -fno-exceptions -D USE_MPI -cxx=g++
mpi: PROFFLAG=
mpi: PROFDIR=-prof-dir=./.MPI-Profiling
mpi_debug: CC=mpicxx
mpi_debug: CFLAGS=-c -O0 -std=c++11 -g -D USE_MPI -cxx=g++
mpi_debug: OPTFLAG=
mpi_debug: PROFFLAG=
